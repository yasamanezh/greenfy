...
(function () {
  ...
  const horizontalBarChartEl = document.querySelector('#horizontalBarChart'),
    horizontalBarChartConfig = {
      ...
      xaxis: {
        categories: ['شنبه 1 دی', 'یک‌شنبه 2 دی', 'دوشنبه 3 دی', 'سه‌شنبه 4 دی', 'چهارشنبه 5 دی', 'پنج‌شنبه 6 دی', 'جمعه 7 دی'],
        axisBorder: {
          show: false
        },
        axisTicks: {
  ...
  const radarChartEl = document.querySelector('#radarChart'),
    radarChartConfig = {
      ...
      xaxis: {
        categories: ['باتری', 'برند', 'دوربین', 'مموری', 'فضا', 'نمایش', 'پردازش', 'قیمت'],
        labels: {
          show: true,
          style: {
